...
public class Time32HelperTest {
	...
	public void testFixedValue(int time32) {
		...
		bb.putInt(time32);
		bb.rewind();
		int time32out = bb.getInt();
		log.debug(String.format("Decoded seconds 0x%x.", time32out));
